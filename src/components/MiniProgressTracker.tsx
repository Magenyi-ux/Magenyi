...
const MiniProgressTracker: React.FC = () => {
    ...
    return (
        <div className="flex items-center gap-3 group relative cursor-pointer">
            <span className="font-bold text-sm text-slate-700">Lvl {level}</span>
            ...
            {/* Tooltip */}
            <div className="absolute top-full right-0 mt-2 p-2 bg-slate-800 text-white text-xs rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10">
