  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100 p-4">
      <div className="w-full max-w-2xl p-8 bg-white rounded-2xl shadow-xl text-center">
        ...
        <h1 className="text-3xl font-extrabold text-black mt-6">
          Configuration Error
        </h1>
        ...
        <div className="mt-6 text-left bg-slate-100 p-4 rounded-lg">
          <p className="font-semibold text-slate-800">To fix this issue:</p>
          <ul className="list-disc list-inside mt-2 space-y-2 text-slate-700">
            ...
            <li>In your Vercel project settings, add a new Environment Variable named <code className="bg-slate-200 font-mono p-1 rounded">VITE_API_KEY</code>.</li>
